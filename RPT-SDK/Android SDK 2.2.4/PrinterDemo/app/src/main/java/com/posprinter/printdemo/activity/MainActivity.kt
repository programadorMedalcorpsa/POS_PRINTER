...
class MainActivity : AppCompatActivity() {
    ...
    private fun initListener() {
        ...
        bind.buttonTsc.setOnClickListener {
        ...
        bind.searchIv.setOnClickListener { view -> netLauncher.launch(Intent(this, SelectNetActivity::class.java)) }
    ...
    private fun refreshButton(connect: Boolean) {
        ...
        bind.buttonTsc.isEnabled = connect
